function probdata = problemToyGrad_Symmetry(pm)
...
job=sprintf('TestGradXwithSymmetry2');
...
% Conductivity, gamma
regTerm=1e-4;
sigma   = [regTerm regTerm 33e6 71e6 1.4e6 regTerm];

% Density, rho
rho     = [0 0 2698 2710 7900 0];

% Young's Modulus, E
E       = [0 0 81 81 210 0]*1e9;
% Mu_r, Ep_r, Sigma, J

% Poisson's Ratio, nu
nu      = [0 0 0.337 0.338 0.283 0];
