function probdata = problemMHIGradXSplit(pm)
...
% Conductivity, gamma
regTerm=1e-4;
sigma   = [71e6 71e6 33e6 33e6 1.4e6 1.4e6 71e6 33e6 1.4e6 regTerm regTerm regTerm];

% Density, rho
rho     = [2710 2710 2698 2698 7900 7900 2710 2698 7900 0 0 0];

% Young's Modulus, E
E       = [81 81 81 81 210 210 81 81 210 0 0 0]*1e9;
% Mu_r, Ep_r, Sigma, J

% Poisson's Ratio, nu
nu      = [0.338 0.338 0.337 0.337 0.283 0.283 0.338 0.337 0.283 0 0 0];
...
D_2=zeros(6);
D_2(1,1)=lambda(3)+2*G(3);
D_2(2,2)=lambda(3)+2*G(3);
D_2(3,3)=lambda(3)+2*G(3);
D_2(4,4)=G(3);
D_2(5,5)=G(3);
D_2(6,6)=G(3);
D_2(1,2)=lambda(3);
...
D_3=zeros(6);
D_3(1,1)=lambda(5)+2*G(5);
D_3(2,2)=lambda(5)+2*G(5);
D_3(3,3)=lambda(5)+2*G(5);
D_3(4,4)=G(5);
D_3(5,5)=G(5);
D_3(6,6)=G(5);
D_3(1,2)=lambda(5);
