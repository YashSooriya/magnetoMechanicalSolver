function probdata = problemToyOVC(pm,option,Jrat)
...
job=sprintf('ToyOVCExtra');
%job=sprintf('ToyOVCQuad1');
...
% Conductivity, gamma
regTerm=1e-4;
sigma   = [regTerm regTerm regTerm regTerm 1.4e6 1.4e6 regTerm regTerm];


% Density, rho
rho     = [0 0 0 0 7900 7900 0 0];

% Young's Modulus, E
E       = [0 0 0 0 210 210 0 0]*1e9;
% Mu_r, Ep_r, Sigma, J

% Poisson's Ratio, nu
nu      = [0 0 0 0 0.283 0.283 0 0];
