function probdata = problemToyGrad_xzCurvedJ2(pm)
...
elseif domain==11 || domain==13
    ...
    if probstatic==0 || probstatic==2
        ...
        elseif y>y2 && z>z1
            ...
            theta=atan2(yp,zp);
                if domain==11
                    src=-1.256637061435917e-06*JAC*[-sin(phi); cos(phi); 0]/sqrt(2)-1.256637061435917e-06*JAC*[0; cos(theta); -sin(theta)]/sqrt(2);
                else
                    src=1.256637061435917e-06*JAC*[-sin(phi); cos(phi);0]/sqrt(2)-1.256637061435917e-06*JAC*[0; cos(theta); -sin(theta)]/sqrt(2);
                end  
        elseif y>y2 && z<z2
