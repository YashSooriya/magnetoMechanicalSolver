function probdata = problemToyCylinder(order,option,Jrat)
...
% Conductivity, gamma
regTerm=1e-3;
sigma   = [regTerm regTerm regTerm regTerm 71e6 71e6 regTerm];


% Density, rho
rho     = [0 0 0 0 2710 2710 0];

% Young's Modulus, E
E       = [0 0 0 0 81 81 0]*1e9;
% Mu_r, Ep_r, Sigma, J

% Poisson's Ratio, nu
nu      = [0 0 0 0 0.338 0.338 0];
