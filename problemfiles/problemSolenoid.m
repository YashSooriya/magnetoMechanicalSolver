function probdata=problemSolenoid(pm)
...
% %interpolation number
 ...
 starp = [0,0,0];   % startpoin of the line
 overp =[2,0,0];   % endpoint of the line
      point = starp;   
 ...
 starp = [2,0,0];   % startpoin of the line
 overp =[25,0,0];   % endpoint of the line
...
theta=atan2(y(i),z(i));
if domain==2
src=Jmag*[0;cos(theta);-sin(theta)];
else
    src=[0;0;0];
end
end
