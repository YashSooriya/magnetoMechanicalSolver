function probdata = problemToyGrad_SymmetryNewBCs(pm)
...
job=sprintf('TestGradXwithSymmetryNewBCs');
...
% Conductivity, gamma
regTerm=1e-4;
sigma   = [1.4e6 33e6 71e6 regTerm regTerm 1.4e6 33e6 71e6 regTerm];

% Density, rho
rho     = [7910 2698 2710 0 0 7910 2698 2710 0];

% Young's Modulus, E
E       = [210 81 81 0 0 210 81 81 0]*1e9;
% Mu_r, Ep_r, Sigma, J

% Poisson's Ratio, nu
nu      = [0.283 0.337 0.338 0 0 0.283 0.337 0.338 0];

mu_r=[1 1 1 1 1 1 1 1 1];
mu=mu_r;
...
matcond=[1 2 3 6 7 8 9];
subdom_mech=[1 2 3 6 7 8];
mur=mu(2)/mu(1);
