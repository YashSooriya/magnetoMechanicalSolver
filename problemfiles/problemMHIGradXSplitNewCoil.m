function probdata = problemMHIGradXSplitNewCoil(pm)
...
nmat = 12;                            % Number of materials
muz = 1.256637061435917e-06;          % Mu_z (Free sopace permeability)
epz = 0;                              % Ep_z
jsrc=[0 0 0 0 0 0];
% Conductivity, gamma
regTerm=1e-4;
sigma   = [47e6 47e6 47e6 41e6 41e6 41e6 1.4e6 1.4e6 1.4e6 regTerm regTerm regTerm];
