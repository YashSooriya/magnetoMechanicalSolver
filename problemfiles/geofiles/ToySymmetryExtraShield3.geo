...
solid cube19=orthobrick(-10,-10,-270e-3;10,10,270e-3);
solid cube20=orthobrick(-10,-10,-270.1e-3;10,10,270.1e-3);

solid Extraout = cylinder (0, 0, -270e-3; 0,0,270e-3;205e-3);
solid Extrain = cylinder (0, 0, -270.1e-3;0,0,270e-3; 199e-3);


solid c19=Extrain and cube20;
solid c20=Extraout and cube19;
solid ExtraLeft= c20 and not c19 -bc=3;


solid Extra2cut1= ExtraLeft and not SymCube1;
solid Extra2cut2= Extra2cut1 and not SymCube2;



tlo Extra2cut2 -col=[1,1,0];

# Extra shield 2

solid Extra2out = cylinder (0, 0, -270e-3; 0,0,270e-3;222e-3);
solid Extra2in = cylinder (0, 0, -270.1e-3;0,0,270e-3;218e-3);


solid c21=Extra2in and cube20;
solid c22=Extra2out and cube19;
solid ExtraLeft2= c22 and not c21 -bc=3;


solid Extra2cut3= ExtraLeft2 and not SymCube1;
solid Extra2cut4= Extra2cut3 and not SymCube2;



tlo Extra2cut4 -col=[1,1,0];

# Extra shield 3

solid Extra3out = cylinder (0, 0, -270e-3; 0,0,270e-3;237e-3);
solid Extra3in = cylinder (0, 0, -270.1e-3;0,0,270e-3;234e-3);


solid c23=Extra3in and cube20;
solid c24=Extra3out and cube19;
solid ExtraLeft3= c24 and not c23 -bc=3;


solid Extra3cut5= ExtraLeft3 and not SymCube1;
solid Extra3cut6= Extra3cut5 and not SymCube2;

tlo Extra3cut6 -col=[1,1,0];

# Extra shield4

solid Extra4out = cylinder (0, 0, -270e-3; 0,0,270e-3;247.5e-3);
solid Extra4in = cylinder (0, 0, -270.1e-3;0,0,270e-3; 245e-3);


solid c25=Extra4in and cube20;
solid c26=Extra4out and cube19;
solid ExtraLeft4= c26 and not c25 -bc=3;





solid Extra4cut1= ExtraLeft4 and not SymCube1;
solid Extra4cut2= Extra4cut1 and not SymCube2;


tlo Extra4cut2 -col=[1,1,0];
...
MainCoil1Cut2)and not MainCoil2Cut2)and not GradientCoil1Cut2)and not GradientCoil2Cut2) and not OVCcut2)and not OVC2cut2)and not Shield4Kcut2) and not Shield4K2cut2) and not Shield77Kcut2) and not Shield77K2cut2)and not Extra2cut2)and not Extra2cut4)and not Extra3cut6)and not Extra4cut2);
