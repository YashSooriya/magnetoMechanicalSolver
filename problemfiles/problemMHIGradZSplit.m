function probdata = problemMHIGradZSplit(pm)
...
% Conductivity, gamma
regTerm=1e-4;
sigma   = [regTerm 71e6 71e6 33e6 33e6 1.4e6 1.4e6 71e6 33e6 1.4e6 regTerm regTerm ];

% Density, rho
rho     = [0 2710 2710 2698 2698 7900 7900 2710 2698 7900 0 0];

% Young's Modulus, E
E       = [0 81 81 81 81 210 210 81 81 210 0 0]*1e9;
% Mu_r, Ep_r, Sigma, J

% Poisson's Ratio, nu
nu      = [0 0.338 0.338 0.337 0.337 0.283 0.283 0.338 0.337 0.283 0 0];
