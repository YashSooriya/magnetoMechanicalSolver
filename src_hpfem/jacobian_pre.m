function [axi,aeta,azeta,asxi,aseta,aszeta,det]=jacobian_pre(flag,gesizet,ph,mycoord)

% function [axi,aeta,azeta,asxi,aseta,aszeta,det]=jacobian_pre(xy,xi,eta,zeta,...
%                                                     eltype,le,lf,flag,gorder,gesizet,ph,mycoord)
...
%pph=gbasish1(xi,eta,zeta,axi,aeta,azeta,gorder+1,eltype,500);
