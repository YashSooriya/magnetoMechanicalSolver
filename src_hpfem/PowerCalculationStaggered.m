function [OutPower] = PowerCalculationStaggered(Mesh,Unknown,Basis,Quadrature,...
            ...
            for pp=1:nip
                ...
                for nBody=1:NmechBodies
                    if any(material==matMech(nBody,:))
                        OutPower(nBody)=OutPower(nBody)+0.5*CondFactorBodies(nBody)*sigma(material)*abs((ElectricField'*ElectricField))*intw(pp)*det;
                    end
                end
...
disp(['The Output Power is: ', num2str(OutPower(1))]);