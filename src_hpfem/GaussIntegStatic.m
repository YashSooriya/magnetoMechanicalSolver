function [M,C,K,Res,StressIntegral]=GaussInteg(Basis,Quadrature,ProblemData,flag,mue,Adc,A0,A,u,mycoord,eltype,probstatic,material,subFlag,ielem,lec,lfc,xy,cond,coupling,StressIntegral,FlagVolume)
%=========================================================================
...
if flag==0   % Linear geometry
    ...
    for i=1:nip
      ...
      % Build each matrix (stiffness, damping, mass and residual)
        ...
        [M_UU]=massLinear(M_UU,esizeH1,subFlag,ProblemData,material,det,H1bas3D,intw);
        [R_A,R_U]=residual(R_A,R_U,mue,Adc,A0,A,u,probstatic,D,subFlag,det,BasisEM,curlBasisEM,H1bas3D,B,intw,current,bodyForce,Grad3D,sigmae,coupling,FlagVolume);
