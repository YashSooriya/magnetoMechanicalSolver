function [known]= DirichletEMP(mesh,Basis,unknown,Quadrature,nrhs,ProblemData,omega,probFlag)
...
ephdx1=Basis.Edge.ephdx1;
ephdy1=Basis.Edge.ephdy1;
ephdz1=Basis.Edge.ephdz1;
ephdx2=Basis.Edge.ephdx2;
ephdy2=Basis.Edge.ephdy2;
ephdz2=Basis.Edge.ephdz2;


ephdfx1=Basis.Face.ephdfx1;
ephdfy1=Basis.Face.ephdfy1;
ephdfz1=Basis.Face.ephdfz1;
ephdfx2=Basis.Face.ephdfx2;
ephdfy2=Basis.Face.ephdfy2;
ephdfz2=Basis.Face.ephdfz2;
    ...
    for j=1:6
        if bcedge(glob(i,j))==2
            ...
            for p=1:nipe
                ...
                [axi,aeta,azeta,asxi,aseta,aszeta,det]=jacobian_pre(flag,gesizet,gphQuade,mycoord);
                end
                ...
                e=fun(x,y,z,index,arg,probstatic,probFlag,omega);
