function [StaticCurrent,UnknownStatic]=SourceMapSolver(Mesh,Basis,Quadrature,ProblemData,couple,freqSweep,Options,Static)

disp('--------------------------------------------')
disp('Running the Static field solver')
disp('--------------------------------------------')
...
[U,~,~,~,~] = linearSystemSolver3(Static,StaticCurrent,Mesh,Basis,Quadrature,UnknownStatic,ProblemData,[X dXdt dXdt2],w0,w1,w2,couple,freqSweep,Assemble);
