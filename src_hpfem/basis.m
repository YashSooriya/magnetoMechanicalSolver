function ph= basis(xi,eta,zeta,axi,aeta,azeta,order,eltype,esize)
...
% p=0 basis functions	
if eltype==1
    ph(1,1:3)=(2*((l(2)*dl(3,1))-(l(3)*dl(2,1)))*axi(1:3))+...
            (2*((l(2)*dl(3,2))-(l(3)*dl(2,2)))*aeta(1:3))+...
            (2*((l(2)*dl(3,3))-(l(3)*dl(2,3)))*azeta(1:3));
    
else
    ph(1,1:3)=(2*((l(3)*dl(2,1))-(l(2)*dl(3,1)))*axi(1:3))+...
        (2*((l(3)*dl(2,2))-(l(2)*dl(3,2)))*aeta(1:3))+...
        (2*((l(3)*dl(2,3))-(l(2)*dl(3,3)))*azeta(1:3));
    
end
	
ph(2,1:3)=(2*((l(1)*dl(3,1))-(l(3)*dl(1,1)))*axi(1:3))+...
    (2*((l(1)*dl(3,2))-(l(3)*dl(1,2)))*aeta(1:3))+...
    (2*((l(1)*dl(3,3))-(l(3)*dl(1,3)))*azeta(1:3));

ph(3,1:3)=(2*((l(1)*dl(2,1))-(l(2)*dl(1,1)))*axi(1:3))+...
    (2*((l(1)*dl(2,2))-(l(2)*dl(1,2)))*aeta(1:3))+...
    (2*((l(1)*dl(2,3))-(l(2)*dl(1,3)))*azeta(1:3));

ph(4,1:3)=(2*((l(1)*dl(4,1))-(l(4)*dl(1,1)))*axi(1:3))+...
    (2*((l(1)*dl(4,2))-(l(4)*dl(1,2)))*aeta(1:3))+...
    (2*((l(1)*dl(4,3))-(l(4)*dl(1,3)))*azeta(1:3));

ph(5,1:3)=(2*((l(2)*dl(4,1))-(l(4)*dl(2,1)))*axi(1:3))+...
    (2*((l(2)*dl(4,2))-(l(4)*dl(2,2)))*aeta(1:3))+...
    (2*((l(2)*dl(4,3))-(l(4)*dl(2,3)))*azeta(1:3));

ph(6,1:3)=(2*((l(3)*dl(4,1))-(l(4)*dl(3,1)))*axi(1:3))+...
    (2*((l(3)*dl(4,2))-(l(4)*dl(3,2)))*aeta(1:3))+...
    (2*((l(3)*dl(4,3))-(l(4)*dl(3,3)))*azeta(1:3));
...
for m=1:6
    for p=1:order
        ...
        if abs(t(m))>1e-12
            ph(m+6*p,1:3)=-(ln(p-1,s(m)/t(m))*(t(m)^p)*dt(m,1)*axi(1:3))-...
...
if order>=2
    ...
    % define the functions for type 2
    for m=1:4
        for i=0:order-2
            for j=0:order-2
                if i+j<=order-2
    ...
    % define the functions for type 3
    if eltype==1
        fae(1,1)=l(3)*dl(2,1)-l(2)*dl(3,1);
        fae(1,2)=l(3)*dl(2,2)-l(2)*dl(3,2);
        fae(1,3)=l(3)*dl(2,3)-l(2)*dl(3,3);
        fae(4,1)=l(2)*dl(1,1)-l(1)*dl(2,1);
        fae(4,2)=l(2)*dl(1,2)-l(1)*dl(2,2);
        fae(4,3)=l(2)*dl(1,3)-l(1)*dl(2,3);
    else
        fae(1,1)=l(2)*dl(3,1)-l(3)*dl(2,1);
        fae(1,2)=l(2)*dl(3,2)-l(3)*dl(2,2);
        fae(1,3)=l(2)*dl(3,3)-l(3)*dl(2,3);
        fae(4,1)=l(3)*dl(1,1)-l(1)*dl(3,1);
        fae(4,2)=l(3)*dl(1,2)-l(1)*dl(3,2);
        fae(4,3)=l(3)*dl(1,3)-l(1)*dl(3,3);
    end
    fae(2,1)=l(3)*dl(1,1)-l(1)*dl(3,1);
    fae(2,2)=l(3)*dl(1,2)-l(1)*dl(3,2);
    fae(2,3)=l(3)*dl(1,3)-l(1)*dl(3,3);
    fae(3,1)=l(2)*dl(1,1)-l(1)*dl(2,1);
    fae(3,2)=l(2)*dl(1,2)-l(1)*dl(2,2);
    fae(3,3)=l(2)*dl(1,3)-l(1)*dl(2,3);
    ...
    for m=1:4
        for j=0:order-2
            ...
            ph(nbas,1:3)=(fae(m,1)*vj)*axi(1:3)+...
                (fae(m,2)*vj)*aeta(1:3)+...
                (fae(m,3)*vj)*azeta(1:3);
    ...
    for j=0:order-3
        for k=0:order-3
            if j+k<=order-3
                ...
                ph(nbas,1:3)=((fai(1)*vj*wk))*axi(1:3)+...
                    ((fai(2)*vj*wk))*aeta(1:3)+...
                    ((fai(3)*vj*wk))*azeta(1:3);
