...
function [helpMatrix,constantD3,ConstantD,bhelp2,bhelp3,bhelp4]= BoundTerms3(esize,esizeH1,intfw,mue,A5,matc,unknown,order,mesh,X,faceNumber,...
    contador,area,Nhf,nm,pp,bhelp2,bhelp3,bhelp4,constantB,A2,Basis3Df,ConstantD,sigmae,probstatic,jCond,ecph,eltypeCond)
