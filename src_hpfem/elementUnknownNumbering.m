function [Unknown]=elementUnknownNumbering(mesh,ProblemData,SplitMech)
...
%-------------------------------------------------------------------------
if SplitMech==1                          %  Split mechanical DOF for different shields
[Unknown]=nounk(mesh,ProblemData);
else
[Unknown]=nounkNS(mesh,ProblemData);     % Do not split mechanical DOF
end
%-------------------------------------------------------------------------
